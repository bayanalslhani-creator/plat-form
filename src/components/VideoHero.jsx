    ...
    <section
      ...
      <motion.div style={{ opacity }} className="relative z-10 flex flex-col items-center px-6 text-center">
        <motion.h1
          ...
          className="text-5xl leading-[1.05] text-studio-silver sm:text-6xl md:text-7xl lg:text-8xl font-black [font-family:'SF_Arabic',_\"SF_Compact\",_\"MyCustomAvenir\",_ui-sans-serif,_system-ui,_sans-serif]">
        ...
        <motion.div
          ...
          <button
            ...
            className="group flex items-center gap-3 rounded-lg border border-studio-silver/25 bg-obsidian/30 px-7 py-4 backdrop-blur-sm transition-all hover:border-white hover:bg-obsidian/50">
            
            <span className="flex h-9 w-9 items-center justify-center rounded-full bg-white text-obsidian transition-transform group-hover:scale-110">
