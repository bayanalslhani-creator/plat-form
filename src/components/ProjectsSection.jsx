      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="mb-14 flex flex-col items-start gap-4 md:mb-20 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h2 className="mt-3 text-3xl leading-tight text-studio-silver md:text-5xl [font-family:'SF_Arabic',_sans-serif] font-bold">
        ...
        <motion.div
          ...
          onClick={() => setDetail(null)}>
            ...
            <img src={detailProject.img} alt={detailProject.title} className="mb-8 block h-auto w-full" />
              ...
              <div className="mt-8">
                <h4 className="text-white text-3xl [font-family:'SF_Arabic',_sans-serif] font-semibold [font-weight:900]">عن العمل</h4>
