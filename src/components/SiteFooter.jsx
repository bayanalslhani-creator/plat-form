    ...
    <footer
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <motion.div
          ...
          <h2 className="mt-6 font-display font-black leading-tight text-studio-silver transition-colors duration-300 hover:text-amber text-6xl md:text-6xl lg:text-6xl">
