...
{
  label: "Instagram",
  href: "https://www.instagram.com/platformsav?igsh=YmJiMTFibDdobGVl",
...
{
  label: "TikTok",
  href: "https://www.tiktok.com/@platformsa?_r=1&_t=ZS-98qnDfTfjTp",
...
{
  label: "X",
  href: "https://x.com/platformsav?s=11",
  path: "M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"
},
{
  label: "LinkedIn",
  href: "https://www.linkedin.com/company/platform-media-co/",
    ...
    <footer
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <motion.div
          ...
          <h2 className="mt-6 font-display font-black leading-tight text-studio-silver transition-colors duration-300 hover:text-amber text-5xl md:text-5xl lg:text-5xl">
