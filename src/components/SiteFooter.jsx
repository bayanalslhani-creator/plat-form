    ...
    <footer
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <motion.div
          ...
          <h2 className="mt-6 font-display font-black leading-tight text-studio-silver transition-colors duration-300 hover:text-amber text-7xl md:text-7xl lg:text-7xl">
